...
const HcStage2AgreeCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="hcStage2Agree-create-dialog-component">
            <div>
            ...
            <div>
                ...
                <Checkbox checked={_entity?.TechTrade} onChange={ (e) => setValByKey("TechTrade", e.checked)}  ></Checkbox>
            </div>
            <div>
            ...
            <div>
                ...
                <Checkbox checked={_entity?.SvTrade} onChange={ (e) => setValByKey("SvTrade", e.checked)}  ></Checkbox>
            </div>
            <div>
            ...
            <div>
                ...
                <Checkbox checked={_entity?.MngrTrade} onChange={ (e) => setValByKey("MngrTrade", e.checked)}  ></Checkbox>
            </div>
            <div>
