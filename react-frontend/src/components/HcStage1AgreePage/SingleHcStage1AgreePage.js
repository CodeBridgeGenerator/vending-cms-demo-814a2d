    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <label className="text-sm text-primary">Ref</label>
                    ...
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.TechProceed}</p></div>
                    ...
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.SvProceed}</p></div>
                    <label className="text-sm text-primary">ManagerName</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.ManagerName}</p></div>
                    <label className="text-sm text-primary">ManagerSign</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.ManagerSign}</p></div>
                    ...
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.ManagerProceed}</p></div>
