...
const CBMasterFormDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10} rowClassName="cursor-pointer">
            ...
            <Column field="DateInspec" header="Date Inspection" body={calendarTemplate5} sortable style={{ minWidth: "8rem" }} />
            <Column field="DateRecall" header="Date recall" body={calendarTemplate6} sortable style={{ minWidth: "8rem" }} />
            <Column field="RecallLoc" header="Recall Location" body={pTemplate7} sortable style={{ minWidth: "8rem" }} />
